  ...
  class BasicCharacterController extends entity.Component {
    ...
    _LoadMinecraftModels() {
      ...
      loader.load('guy.fbx', (fbx) => {
        ...
        // loader.setPath('http://localhost:8080/_resources/fbx/guy/');
        let baseResUrl = "http://localhost:8080/_resources/fbx/guy/"
    ...
    ___LoadMinecraftModels() {
      ...
      let baseResUrl = "http://localhost:8080/_resources/pets/stebb/"
      ...
      loader.load(baseResUrl+'stebb2.fbx', (fbx) => {
        ...
        // let baseResUrl = "http://localhost:8080/_resources/pets/stebb/"
        // loader.load('Sword And Shield Idle.fbx', (a) => { _OnLoad('idle', a); });
        loader.load('http://localhost:8080/_resources/pets/stebb/Standing W_Briefcase Idle.fbx', (a) => { _OnLoad('idle', a); });
        loader.load('http://localhost:8080/_resources/pets/stebb/Hiding Grab.fbx', (a) => { _OnLoad('attack', a); });
        if (this.canFly)
        {
          loader.load('http://localhost:8080/_resources/pets/stebb/Running.fbx', (a) => { _OnLoad('walk', a); });
          loader.load('http://localhost:8080/_resources/pets/stebb/Swimming To Edge.fbx', (a) => { _OnLoad('run', a); });
        } else {
          loader.load('http://localhost:8080/_resources/pets/stebb/Walking.fbx', (a) => { _OnLoad('walk', a); });
          loader.load('http://localhost:8080/_resources/pets/stebb/Running.fbx', (a) => { _OnLoad('run', a); });
        }
        // loader.load('http://localhost:8080/_resources/pets/stebb/Swimming To Edge.fbx', (a) => { _OnLoad('run', a); });
        loader.load('http://localhost:8080/_resources/pets/stebb/Skateboarding.fbx', (a) => { _OnLoad('hover', a); });
        loader.load('http://localhost:8080/_resources/pets/stebb/Getting Hit Backwards.fbx', (a) => { _OnLoad('death', a); });
        // loader.load('http://localhost:8080/_resources/pets/stebb/Tut Hip Hop Dance.fbx', (a) => { _OnLoad('dance', a); });
        loader.load('http://localhost:8080/_resources/pets/stebb/Falling Flat Impact.fbx', (a) => { _OnLoad('dance', a); });
    ...
    _LoadMagicaModels() {
      ...
      loader.load('http://localhost:8080/_resources/fbx/girl/girl2.fbx', (fbx) => {
        this._target = fbx;
        // this._target.scale.setScalar(1);
        // this._target.scale.setScalar(0.0056);
        this._target.scale.setScalar(0.056);
